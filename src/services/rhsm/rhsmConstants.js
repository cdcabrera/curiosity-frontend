 ...
 *     RHEL_X86_HA: string, RHEL_X86_SAP: string, RHEL_AUS_ADDON: string, RHEL_BALLS: string, RHEL_HELLO_WORLD: string,
 *     RHEL_IBM_Z: string, RHEL_IBM_POWER: string, RHEL_LOREM_IPSUM: string, RHEL_X86:
 *     string}}
 */
const RHSM_API_PATH_PRODUCT_VARIANT_RHEL_TYPES = {
  ...
  RHEL_HELLO_WORLD: 'rhelHelloWorld',
 ...
 *     RHDS: string, RHLI: string, RHOTV: string}}
 */
 ...
 *     RHEL_AUS_ADDON: string, RHEL_BALLS: string, RHEL_HELLO_WORLD: string, RHEL_IBM_Z: string, RHEL_IBM_POWER:
 *     string, RHEL_LOREM_IPSUM: string, RHEL_X86: string}, RHSM_API_RESPONSE_SUBSCRIPTIONS_DATA_TYPES:
 ...
 *     string, ANSIBLE: string, RHEL_AUS_ADDON: string, RHEL_BALLS: string, RHEL_HELLO_WORLD: string,
 *     SATELLITE_CAPSULE: string, RHEL_IBM_Z: string, RHEL_IBM_POWER: string, RHEL_LOREM_IPSUM: string, RHACS: string,
 *     RHDS: string, RHLI: string, RHOTV: string}, RHSM_API_RESPONSE_BILLING_PROVIDER_TYPES: {AZURE: string, GCP:
