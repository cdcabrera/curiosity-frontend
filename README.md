...
**Final Step:**
4. **Create a `conversation-savepoint.md` in the `.agent/` directory.** This file should be used to save the current state of your conversation so that you or a future agent can resume the chat context at any time.
-->
